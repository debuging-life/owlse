...
final class ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        sections = [
            MenuSection(title: "Main", footer: "Demonstartes how to show the entire OwlseUI interface (all four tabs)", items: [
            ...
            MenuSection(title: "Components", footer: "Demonstrates how you can push individual OwlseUI screens into an existing navigation (UINavigationController or NavigationView)", items: [
