...
extension NSAttributedString.Key {
    package static let objectId = NSAttributedString.Key("owlse-object-id-key")
    package static let isTechnical = NSAttributedString.Key("owlse-technical-substring-key")
    package static let subheadline = NSAttributedString.Key("owlse-subheadline-key")
}
