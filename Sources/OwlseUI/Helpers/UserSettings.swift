...
public final class UserSettings: ObservableObject {
    ...
    @AppStorage("com.github.kean.owlse.showCurrentRequest")
    ...
    @AppStorage("com.github.kean.owlse.allowedShareStoreOutputs")
    var rawAllowedShareStoreOutputs: String = "[]"

    /// If enabled, the console stops showing the remote logging option.
    @AppStorage("com.github.kean.owlse.isRemoteLoggingAllowed")
    ...
    @AppStorage("com.github.kean.owlse.DisplayOptions")
