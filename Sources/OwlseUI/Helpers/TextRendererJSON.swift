...
extension NSAttributedString.Key {
    package static let decodingError = NSAttributedString.Key(rawValue: "com.github.kean.owlse.decoding-error-key")
    package static let node = NSAttributedString.Key(rawValue: "com.github.kean.owlse.json-container-node")
}
