...
package final class OwlseDocument {
    ...
    package init(documentURL: URL) throws {
        ...
        self.container = NSPersistentContainer(name: documentURL.lastPathComponent, managedObjectModel: OwlseDocument.model)
    ...
    nonisolated(unsafe) static let model: NSManagedObjectModel = {
        ...
        let blob = NSEntityDescription(class: OwlseBlobEntity.self)
        blob.properties = [
...
package final class OwlseBlobEntity: NSManagedObject {
