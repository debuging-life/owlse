...
/// a server is a Owlse Pro app for macOS).
@MainActor
public final class RemoteLogger: ObservableObject, RemoteLoggerConnectionDelegate {
    ...
    @AppStorage("com-github-kean-owlse-is-remote-logger-enabled")
    public private(set) var isEnabled = false

    @AppStorage("com-github-kean-owlse-selected-server")
    ...
    private let keychain = Keychain(service: "com.github.kean.owlse")
    ...
    @AppStorage("com-github-kean-owlse-known-servers")
    ...
    /// Owlse Mac app and remember it for the next runs.
    ///
...
private func getFallbackDeviceId() -> UUID {
    let key = "com-github-com-kean-owlse-device-id"
...
extension RemoteLogger {
    package static let serviceType = "_owlse._tcp"
}
