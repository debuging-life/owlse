...
package struct URLSessionMockedResponse: Codable {
    ...
    /// Artificial latency (seconds) before the response is delivered.
    /// Optional so payloads to and from older clients keep decoding.
    package var delay: Double?

    package init(errorCode: Int?, statusCode: Int?, headers: [String : String]?, body: String? = nil, delay: Double? = nil) {
