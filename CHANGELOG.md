...
> **Note (Owlse fork):** everything below is the release history of the
> upstream [Pulse](https://github.com/kean/Pulse) project this repo was
> forked from, kept verbatim for reference. Names and links refer to Pulse.
